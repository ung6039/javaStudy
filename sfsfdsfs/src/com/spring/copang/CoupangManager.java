...
//		for(page =1; page<=17; page++){
			try{
				System.out.println("!!");
				Document doc = Jsoup.connect("https://www.coupang.com/np/categories/195268?listSize=60&brand=&offerCondition=&filterType=&isPriceRange=false&minPrice=&maxPrice=&page=1&channel=user&fromComponent=Y&selectedPlpKeepFilter=&sorter=bestAsc&filter=&component=195168&rating=0")
						.post();
