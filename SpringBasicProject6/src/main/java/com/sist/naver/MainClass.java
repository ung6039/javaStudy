...
public class MainClass {
	...
	public static void main(String[] args)  throws Exception{
		String clientId = "ozojeP1u4AFXP4ZVaDus"; // 애플리케이션 클라이언트 아이디값"
		String clientSecret = "hOkALSCinI"; // 애플리케이션 클라이언트 시크릿값"

		String text = null;
		try {
			text = URLEncoder.encode("삼각김밥", "UTF-8");
...
//		String apiURL = "https://openapi.naver.com/v1/search/blog?query=" + text; // json
		...
		String apiURL = "https://openapi.naver.com/v1/search/blog?display=100&start=1&query=" + text;																			// 결과
		// String apiURL =
